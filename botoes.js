...
const btnHemocentro = document.getElementById('btnHemocentro');
const doadorSection = document.getElementById('doador');
const hemocentroSection = document.getElementById('hemocentro');
